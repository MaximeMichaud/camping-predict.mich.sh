...
function displayBat() {
    ...
    if (km >= 1 && km <= 28) {
        ...
        if (km >= 1 && km <= 24) {
            liste += '<option value="1">Bâtiment non-déterré</option>';
        }
        if (km >= 10 && km <= 13) {
        ...
        if (km >= 2 && km <= 5) {
            liste += '<option value="36">Ambulance</option>';
        }
        if (km >= 12 && km <= 15) {
        ...
        if (km >= 5 && km <= 8) {
            liste += '<option value="19">BricoTout</option>';
        }
        if (km >= 5 && km <= 28) {
        ...
        if (km >= 4 && km <= 7) {
            liste += '<option value="2">Carlingue d\'avion</option>';
        }
        if (km >= 3 && km <= 6) {
        ...
        if (km >= 3 && km <= 6) {
            liste += '<option value="27">Caverne</option>';
        }
        if (km >= 16 && km <= 19) {
        ...
        if (km >= 3 && km <= 6) {
            liste += '<option value="23">Kebab "Chez Coluche"</option>';
        }
        if (km >= 2 && km <= 5) {
        ...
        if (km >= 2 && km <= 5) {
            liste += '<option value="12">Petite Maison</option>';
        }
        if (km >= 4 && km <= 7) {
        ...
        if (km >= 5 && km <= 8) {
            liste += '<option value="32">Tranchée aménaée</option>';
        }
        if (km >= 21 && km <= 28) {
        ...
        if (km >= 3 && km <= 6) {
            liste += '<option value="3">Vieille Pompe Hydraulique</option>';
        }
        if (km >= 12 && km <= 15) {
            liste += '<option value="25">Villa de Duke</option>';
        }
        if (km >= 3 && km <= 6) {
            liste += '<option value="4">Villa délabrée</option>';
        }
    ...
    if (villeGet != null || metierGet != null || kmGet != null || batGet != null || zGet != null || ameGet != null || odGet != null || cgGet != null || crGet != null ||
        ...
        if ((villeGet == 0 || villeGet == 1 || villeGet == 2) && (metierGet == 0 || metierGet == 1 || metierGet == 2) && kmGet >= 1 && kmGet <= 28 &&
            ...
            if (s14CorrGet == 0 || s14CorrGet == 1) {
                if (s14CorrGet == 0) {
                    $("#s14").removeAttr('checked');
                } else if (s14CorrGet == 1) {
            ...
            if (furtifGet == 1 && metierGet == 2) {
                $("#furtif").attr({checked: true});
            } else {
                $("#furtif").removeAttr('checked');
            }
